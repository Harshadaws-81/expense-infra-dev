resource "aws_ssm_parameter" "mysql_sg_id" {
  # storing name as - /expense/dev/mysql_sg_id
...
resource "aws_ssm_parameter" "backend_sg_id" {
  # storing name as - /expense/dev/backend_sg_id
...
resource "aws_ssm_parameter" "frontend_sg_id" {
  # storing name as - /expense/dev/frontend_sg_id
...
resource "aws_ssm_parameter" "bastion_sg_id" {
  # storing name as - /expense/dev/bastion_sg_id
...
resource "aws_ssm_parameter" "ansible_sg_id" {
  # storing name as - /expense/dev/ansible_sg_id
...
resource "aws_ssm_parameter" "web_alb_sg_id" {
  ...
  type  = "String"
  value = module.web_alb_sg_id.value
}